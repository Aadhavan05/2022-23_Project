                    ...
                    <tbody>
                        <tr>
                            ...
                            <?php if($row['status'] == 'requested') : ?>
                                <a class="btn btn-warning" status="assigned" requestid="<?= $row['id'] ?>" onclick="setStatus(this);"><i class="fa-solid fa-circle-check"></i> Assign</a>
                            <?php elseif($row['status'] == 'assigned') : ?>
                                <a class="btn btn-success" status="completed" requestid="<?= $row['id'] ?>" onclick="setStatus(this);"><i class="fa-solid fa-circle-check"></i> Complete</a>
                            <?php endif; ?>
                            </td>
                        </tr>
                        <?php } ?>
