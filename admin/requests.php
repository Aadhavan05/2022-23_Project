                ...
                <div class="row row-cols-1 row-cols-md-3 g-4 mt-2">
                    <div class="col">
                        ...
                        <div class="card-footer">
                            <a class="btn btn-warning" href="./view.php?service=electricwork"><i class="fa-regular fa-eye"></i> View Requests</a>    
                        </div>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        ...
                        <div class="card-footer">
                            <a class="btn btn-warning" href="./view.php?service=carpentry"><i class="fa-regular fa-eye"></i> View Requests</a>    
                        </div>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        ...
                        <div class="card-footer">
                            <a class="btn btn-warning" href="./view.php?service=roomcleaning"><i class="fa-regular fa-eye"></i> View Requests</a>    
                        </div>
                        </div>
                    </div>
