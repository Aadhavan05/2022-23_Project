    ...
    <div class="container-fluid">
        <div class="row flex-nowrap">
            ...
            <div class="col py-3 bg-light text-center">
                <h3 class="text-primary mb-4">Feedbacks provided by students</h3>

                <?php while($row = mysqli_fetch_assoc($result)) { 
                    $day = date('l', strtotime($row['registered']));
                ?>

                <div class="row border  border-warning bg-light rounded shadow m-3 p-2 mt-3">
                    <div class="col border-light border-2">
                        <!-- Content for the first column -->
                        <h5><u>Requested</u></h5>

                        <p><b>By: </b><?= $row['name']; ?></p>
                        <p><b>From: </b><?= $row['block']."-".$row['roomNo'] ?></p>
                    </div>
                    <div class="col border-light border-2 ">
