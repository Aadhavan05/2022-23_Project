    ...
    <div class="container-fluid">
        <div class="row flex-nowrap">
            ...
            <div class="col py-3 bg-light">
                <h3 class="text-primary mb-3 text-center">Book your solts</h3>

                <p id="clock" class="fw-bold text-danger d-flex justify-content-end"></p>

                <form method="POST" onsubmit="return validate();" action="../backend/insertService.php"
                class="m-3 p-3 border w-75 mx-auto rounded shadow">
                    ...
                    <input type="hidden" value="<?= $days[0] ?>" name="day1">
                    <input type="hidden" value="<?= $days[1] ?>" name="day2">
                    <input type="hidden" value="<?= $days[2] ?>" name="day3">

                    <div class="form-row row mb-3">
                        <label for="from1" class="col-sm-2 col-form-label fw-bold"><?= $days[0] ?>:</label>
                        <div class="form-group col-md-4 mb-2">
                            ...
                            <select id="from1" name="from1" class="form-control" onchange="show(this, document.getElementById('to1'));" required>
                                <option value="" hidden>-- Select From Time --</option>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select id="to1" name="to1" class="form-control" required>
                                <option value="" hidden>-- Select To Time --</option>
                                <option value="11:00 AM">11:00 AM</optoin>
                                <option value="12:00 PM">12:00 PM</optoin>
                                <option value="01:00 PM">01:00 PM</optoin>
                                <option value="02:00 PM">02:00 PM</optoin>
                    ...
                    <div class="form-row row mb-3">
                        <label for="from2" class="col-sm-2 col-form-label fw-bold"><?= $days[1] ?>:</label>
                        <div class="form-group col-md-4 mb-2">
                            <!-- <label for="from">From time:</label> -->
                    ...
                    <div class="form-row row mb-3">
                        <label for="from3" class="col-sm-2 col-form-label fw-bold"><?= $days[2] ?>:</label>
                        <div class="form-group col-md-4 mb-2">
                            <!-- <label for="from">From time:</label> -->
                    ...
                    <?php if($service != "roomcleaning") : ?>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea maxlength="300" class="form-control" id="complaints" name="complaints" placeholder="Enter your complaints" required></textarea>
                            </div>
                        </div>

                    <?php endif; ?>
                    <button type="submit" class="btn btn-primary" name="submit"><i class="fa-solid fa-paper-plane"></i> Submit</button>
                </form>
            </div>
